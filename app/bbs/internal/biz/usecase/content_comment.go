...
func (u *ContentCommentUsecase) CreateComment(ctx context.Context, req *CreateCommentReq) (*repo.CommentDetail, error) {
	resp, err := u.contentCommentClient.CreateComment(ctx, &repo.CreateCommentReq{UserID: req.UserID, ArticleID: req.ArticleID, Content: req.Content, ReplyID: req.ReplyID})
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (u *ContentCommentUsecase) ListComments(ctx context.Context, req *ListCommentsReq) (*ListCommentsResp, error) {
	...
	resp, err := u.contentCommentClient.ListComments(ctx, &repo.ListCommentsReq{UserID: req.UserID, Page: page, Query: query})
	if err != nil {
		return nil, err
	}
	return &ListCommentsResp{Page: resp.Page, Rows: resp.Rows}, nil
}
...
func (u *ContentCommentUsecase) ListCommentThreads(ctx context.Context, req *ListCommentThreadsReq) (*ListCommentThreadsResp, error) {
	...
	resp, err := u.contentCommentClient.ListCommentThreads(ctx, &repo.ListCommentThreadsReq{UserID: req.UserID, Page: page, ArticleID: req.ArticleID, Order: order, ReplyPreviewLimit: req.ReplyPreviewLimit})
	if err != nil {
		return nil, err
	}
	return &ListCommentThreadsResp{Page: resp.Page, Rows: resp.Rows}, nil
}
...
func (u *ContentCommentUsecase) ListCommentReplies(ctx context.Context, req *ListCommentRepliesReq) (*ListCommentRepliesResp, error) {
	...
	resp, err := u.contentCommentClient.ListCommentReplies(ctx, &repo.ListCommentRepliesReq{UserID: req.UserID, Page: page, ArticleID: req.ArticleID, ParentID: req.ParentID, Order: order})
	if err != nil {
		return nil, err
	}
	return &ListCommentRepliesResp{Page: resp.Page, Rows: resp.Rows}, nil
}
...
func (u *ContentCommentUsecase) ListCommentTimeline(ctx context.Context, req *ListCommentTimelineReq) (*ListCommentTimelineResp, error) {
	...
	resp, err := u.contentCommentClient.ListCommentTimeline(ctx, &repo.ListCommentTimelineReq{UserID: req.UserID, Page: page, ArticleID: req.ArticleID, Order: order})
	if err != nil {
		return nil, err
	}
	return &ListCommentTimelineResp{Page: resp.Page, Rows: resp.Rows}, nil
}
...
func (u *ContentCommentUsecase) LikeComment(ctx context.Context, req *LikeCommentReq) (bool, error) {
	resp, err := u.contentCommentClient.LikeComment(ctx, &repo.LikeCommentReq{UserID: req.UserID, ID: req.ID, Active: req.Active})
	if err != nil {
		return false, err
	}
	return resp, nil
...
func (u *ContentCommentUsecase) ThankComment(ctx context.Context, req *ThankCommentReq) (bool, error) {
	resp, err := u.contentCommentClient.ThankComment(ctx, &repo.ThankCommentReq{UserID: req.UserID, ID: req.ID, Active: req.Active})
	if err != nil {
		return false, err
	}
	return resp, nil
