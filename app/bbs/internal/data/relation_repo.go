...
func (r *RelationClient) Follow(ctx context.Context, req *repo.FollowRelationReq) error {
	_, err := r.userClient.Relation.Follow(ctx, &userv1.FollowRelation_Req{ActorId: req.ActorID, TargetId: req.TargetID})
	if err != nil {
		return err
	}
	return nil
...
func (r *RelationClient) Unfollow(ctx context.Context, req *repo.UnfollowRelationReq) error {
	_, err := r.userClient.Relation.Unfollow(ctx, &userv1.UnfollowRelation_Req{ActorId: req.ActorID, TargetId: req.TargetID})
	if err != nil {
		return err
	}
	return nil
...
func (r *RelationClient) Block(ctx context.Context, req *repo.BlockRelationReq) error {
	_, err := r.userClient.Relation.Block(ctx, &userv1.BlockRelation_Req{ActorId: req.ActorID, TargetId: req.TargetID})
	if err != nil {
		return err
	}
	return nil
...
func (r *RelationClient) Unblock(ctx context.Context, req *repo.UnblockRelationReq) error {
	_, err := r.userClient.Relation.Unblock(ctx, &userv1.UnblockRelation_Req{ActorId: req.ActorID, TargetId: req.TargetID})
	if err != nil {
		return err
	}
	return nil
...
func (r *RelationClient) ListFollowing(ctx context.Context, req *repo.ListFollowingRelationsReq) (*repo.ListFollowingRelationsResp, error) {
	...
	reply, err := r.userClient.Relation.ListFollowing(ctx, &userv1.ListFollowingRelations_Req{Page: pageReq, UserId: req.ActorID})
	if err != nil {
		return nil, err
	}
...
func (r *RelationClient) ListFollowers(ctx context.Context, req *repo.ListFollowersRelationsReq) (*repo.ListFollowersRelationsResp, error) {
	...
	reply, err := r.userClient.Relation.ListFollowers(ctx, &userv1.ListFollowersRelations_Req{Page: pageReq, UserId: req.ActorID})
	if err != nil {
		return nil, err
	}
	var page *repo.PageResp
...
func (r *RelationClient) ListBlocked(ctx context.Context, req *repo.ListBlockedRelationsReq) (*repo.ListBlockedRelationsResp, error) {
	...
	reply, err := r.userClient.Relation.ListBlocked(ctx, &userv1.ListBlockedRelations_Req{Page: pageReq, UserId: req.ActorID})
	if err != nil {
		return nil, err
	}
	var page *repo.PageResp
...
func (r *RelationClient) GetStatus(ctx context.Context, req *repo.GetStatusRelationReq) (*repo.RelationStatus, error) {
	reply, err := r.userClient.Relation.MapStatus(ctx, &userv1.MapRelationStatuses_Req{ActorId: req.ActorID, TargetIds: []int64{req.TargetID}})
	if err != nil {
		return nil, err
	}
