...
type connectorFunc func(context.Context, *gen.connectorMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f connectorFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.connectorMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.connectorMutation", m)
}
