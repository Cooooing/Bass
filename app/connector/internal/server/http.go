...
func NewHTTPServer(c *conf.Bootstrap, logger log.Logger, services []service.Service, websocket *service.WebsocketService) *http.Server {
	...
	srv.Handle("/ws", websocket.Handler())
