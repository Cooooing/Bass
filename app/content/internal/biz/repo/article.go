...
type ArticleRepo interface {
	...
	UpdateStatus(ctx context.Context, articleId int64, status v1.ArticleStatus) error
	UpdateControlFields(ctx context.Context, articleId int64, status v1.ArticleStatus, commentable bool, anonymous bool, listable *bool) error
	UpdateHasPostscript(ctx context.Context, articleId int64, hasPostscript bool) error
	UpdateStat(ctx context.Context, articleId int64, action v1.ArticleAction, num int32) (*model.Article, error)
	UpdateAcceptAnswer(ctx context.Context, articleId int64, commentId int64) (*model.Article, error)
	Publish(ctx context.Context, articleId int64) (*model.Article, error)
	...
	GetPage(ctx context.Context, page *common.PageRequest, req *ArticleGetReq) ([]*model.Article, *common.PageReply, error)
}
...
type ArticleActionRecordRepo interface {
	...
	GetPage(ctx context.Context, page *common.PageRequest, req *ArticleActionRecordReq) ([]*model.ArticleActionRecord, *common.PageReply, error)
}
