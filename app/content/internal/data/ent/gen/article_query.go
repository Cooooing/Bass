...
// QueryPostscripts chains the current query on the "postscripts" edge.
func (_q *ArticleQuery) QueryPostscripts() *ArticlePostscriptQuery {
	query := (&ArticlePostscriptClient{config: _q.config}).Query()
...
func (_q *ArticleQuery) QueryVotes() *ArticleVoteQuery {
...
// QueryLotteries chains the current query on the "lotteries" edge.
func (_q *ArticleQuery) QueryLotteries() *ArticleLotteryQuery {
...
func (_q *ArticleQuery) QueryTags() *TagQuery {
...
// WithPostscripts tells the query-builder to eager-load the nodes that are connected to
// the "postscripts" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ArticleQuery) WithPostscripts(opts ...func(*ArticlePostscriptQuery)) *ArticleQuery {
	query := (&ArticlePostscriptClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withPostscripts = query
	return _q
}
...
func (_q *ArticleQuery) WithVotes(opts ...func(*ArticleVoteQuery)) *ArticleQuery {
	query := (&ArticleVoteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithLotteries tells the query-builder to eager-load the nodes that are connected to
// the "lotteries" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ArticleQuery) WithLotteries(opts ...func(*ArticleLotteryQuery)) *ArticleQuery {
	query := (&ArticleLotteryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withLotteries = query
	return _q
}
...
func (_q *ArticleQuery) WithTags(opts ...func(*TagQuery)) *ArticleQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ArticleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Article, error) {
	...
	if query := _q.withPostscripts; query != nil {
		if err := _q.loadPostscripts(ctx, query, nodes,
			func(n *Article) { n.Edges.Postscripts = []*ArticlePostscript{} },
			func(n *Article, e *ArticlePostscript) { n.Edges.Postscripts = append(n.Edges.Postscripts, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVotes; query != nil {
		if err := _q.loadVotes(ctx, query, nodes,
			func(n *Article) { n.Edges.Votes = []*ArticleVote{} },
			func(n *Article, e *ArticleVote) { n.Edges.Votes = append(n.Edges.Votes, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLotteries; query != nil {
		if err := _q.loadLotteries(ctx, query, nodes,
			func(n *Article) { n.Edges.Lotteries = []*ArticleLottery{} },
			func(n *Article, e *ArticleLottery) { n.Edges.Lotteries = append(n.Edges.Lotteries, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *ArticleQuery) loadPostscripts(ctx context.Context, query *ArticlePostscriptQuery, nodes []*Article, init func(*Article), assign func(*Article, *ArticlePostscript)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(articlepostscript.FieldArticleID)
	}
	query.Where(predicate.ArticlePostscript(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(article.PostscriptsColumn), fks...))
	}))
...
func (_q *ArticleQuery) loadVotes(ctx context.Context, query *ArticleVoteQuery, nodes []*Article, init func(*Article), assign func(*Article, *ArticleVote)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(articlevote.FieldArticleID)
	}
	query.Where(predicate.ArticleVote(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(article.VotesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ArticleQuery) loadLotteries(ctx context.Context, query *ArticleLotteryQuery, nodes []*Article, init func(*Article), assign func(*Article, *ArticleLottery)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(articlelottery.FieldArticleID)
	}
	query.Where(predicate.ArticleLottery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(article.LotteriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
