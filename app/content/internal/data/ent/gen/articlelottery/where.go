...
func CreatedAtIsNil() predicate.ArticleLottery {
	return predicate.ArticleLottery(sql.FieldIsNull(FieldCreatedAt))
}

// CreatedAtNotNil applies the NotNil predicate on the "created_at" field.
func CreatedAtNotNil() predicate.ArticleLottery {
	return predicate.ArticleLottery(sql.FieldNotNull(FieldCreatedAt))
}
...
func UpdatedAtIsNil() predicate.ArticleLottery {
	return predicate.ArticleLottery(sql.FieldIsNull(FieldUpdatedAt))
}

// UpdatedAtNotNil applies the NotNil predicate on the "updated_at" field.
func UpdatedAtNotNil() predicate.ArticleLottery {
	return predicate.ArticleLottery(sql.FieldNotNull(FieldUpdatedAt))
}
