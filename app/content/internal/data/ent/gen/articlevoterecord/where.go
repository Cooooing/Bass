...
func CreatedAtIsNil() predicate.ArticleVoteRecord {
	return predicate.ArticleVoteRecord(sql.FieldIsNull(FieldCreatedAt))
}

// CreatedAtNotNil applies the NotNil predicate on the "created_at" field.
func CreatedAtNotNil() predicate.ArticleVoteRecord {
	return predicate.ArticleVoteRecord(sql.FieldNotNull(FieldCreatedAt))
}
...
func UpdatedAtIsNil() predicate.ArticleVoteRecord {
	return predicate.ArticleVoteRecord(sql.FieldIsNull(FieldUpdatedAt))
}

// UpdatedAtNotNil applies the NotNil predicate on the "updated_at" field.
func UpdatedAtNotNil() predicate.ArticleVoteRecord {
	return predicate.ArticleVoteRecord(sql.FieldNotNull(FieldUpdatedAt))
}
