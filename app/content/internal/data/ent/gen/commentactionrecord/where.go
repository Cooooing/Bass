...
func HasComment() predicate.CommentActionRecord {
	return predicate.CommentActionRecord(func(s *sql.Selector) {
...
func HasCommentWith(preds ...predicate.Comment) predicate.CommentActionRecord {
	return predicate.CommentActionRecord(func(s *sql.Selector) {
		step := newCommentStep()
...
func And(predicates ...predicate.CommentActionRecord) predicate.CommentActionRecord {
	return predicate.CommentActionRecord(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.CommentActionRecord) predicate.CommentActionRecord {
	return predicate.CommentActionRecord(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.CommentActionRecord) predicate.CommentActionRecord {
	return predicate.CommentActionRecord(sql.NotPredicates(p))
}
