...
func (_q *TagQuery) QueryArticle() *ArticleQuery {
...
func (_q *TagQuery) QueryDomain() *DomainQuery {
...
func (_q *TagQuery) WithArticle(opts ...func(*ArticleQuery)) *TagQuery {
	query := (&ArticleClient{config: _q.config}).Query()
...
func (_q *TagQuery) WithDomain(opts ...func(*DomainQuery)) *TagQuery {
	query := (&DomainClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withDomain; query != nil {
		if err := _q.loadDomain(ctx, query, nodes, nil,
			func(n *Tag, e *Domain) { n.Edges.Domain = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TagQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDomain != nil {
			_spec.Node.AddColumnOnce(tag.FieldDomainID)
		}
	}
