...
func (r *OutboxEventRepo) Map(ctx context.Context, req *repo.OutboxEventGetReq) (map[int64]*repo.OutboxEvent, error) {
	...
	return lo.SliceToMap(list, func(item *repo.OutboxEvent) (int64, *repo.OutboxEvent) {
		return item.ID, item
	}), nil
}
...
func (r *OutboxEventRepo) Page(ctx context.Context, page *common.PageRequest, req *repo.OutboxEventGetReq) ([]*repo.OutboxEvent, *common.PageReply, error) {
