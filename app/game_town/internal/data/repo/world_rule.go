...
func NewWorldRuleRepo(db *gen.Client) bizrepo.WorldRuleRepo {
	return &WorldRuleRepo{db: db}
}
...
func (r *WorldRuleRepo) Page(ctx context.Context, req *bizrepo.WorldRulePageReq) (*bizrepo.WorldRulePageResp, error) {
	...
	return &bizrepo.WorldRulePageResp{Rows: out, Page: basePage(total, p)}, nil
}
