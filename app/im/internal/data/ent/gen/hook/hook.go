...
// The ChatGroupFunc type is an adapter to allow the use of ordinary
// function as ChatGroup mutator.
type ChatGroupFunc func(context.Context, *gen.ChatGroupMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ChatGroupFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ChatGroupMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ChatGroupMutation", m)
}

// The ChatGroupMemberFunc type is an adapter to allow the use of ordinary
// function as ChatGroupMember mutator.
type ChatGroupMemberFunc func(context.Context, *gen.ChatGroupMemberMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ChatGroupMemberFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ChatGroupMemberMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ChatGroupMemberMutation", m)
}

// The ChatMessageFunc type is an adapter to allow the use of ordinary
// function as ChatMessage mutator.
type ChatMessageFunc func(context.Context, *gen.ChatMessageMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ChatMessageFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ChatMessageMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ChatMessageMutation", m)
}
