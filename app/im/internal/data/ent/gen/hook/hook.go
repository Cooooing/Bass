...
// The IMFunc type is an adapter to allow the use of ordinary
// function as IM mutator.
type IMFunc func(context.Context, *gen.IMMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f IMFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.IMMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.IMMutation", m)
}
