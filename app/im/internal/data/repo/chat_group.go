...
func (r *ChatGroupRepo) getClient(
	ctx context.Context,
) *gen.Client {
...
func (r *ChatGroupRepo) Save(
	ctx context.Context,
	chatGroup *model.ChatGroup,
) (*model.ChatGroup, error) {
...
func (r *ChatGroupRepo) UpdateAvatar(
	ctx context.Context,
	req *repo.ChatGroupUpdateAvatarReq,
) (*model.ChatGroup, error) {
...
func (r *ChatGroupRepo) UpdateOwner(
	ctx context.Context,
	req *repo.ChatGroupUpdateOwnerReq,
) (*model.ChatGroup, error) {
	update, err := r.getClient(ctx).ChatGroup.UpdateOneID(req.ChatGroupID).
...
func (r *ChatGroupRepo) UpdateLastMessage(
	ctx context.Context,
	req *repo.ChatGroupUpdateLastMessageReq,
) (*model.ChatGroup, error) {
...
func (r *ChatGroupRepo) UpdateMemberCount(
	ctx context.Context,
	req *repo.ChatGroupUpdateMemberCountReq,
) (*model.ChatGroup, error) {
	update, err := r.getClient(ctx).ChatGroup.UpdateOneID(req.ChatGroupID).
...
func (r *ChatGroupRepo) UpdateStatus(
	ctx context.Context,
	req *repo.ChatGroupUpdateStatusReq,
) (*model.ChatGroup, error) {
	update, err := r.getClient(ctx).ChatGroup.UpdateOneID(req.ChatGroupID).
...
func (r *ChatGroupRepo) Get(
	ctx context.Context,
	req *repo.ChatGroupQuery,
) (*model.ChatGroup, error) {
...
func (r *ChatGroupRepo) Map(
	ctx context.Context,
	req *repo.ChatGroupQuery,
) (map[int64]*model.ChatGroup, error) {
...
func (r *ChatGroupRepo) Page(
	ctx context.Context,
	req *repo.ChatGroupQuery,
) (*repo.ChatGroupPageResp, error) {
...
func (r *ChatGroupRepo) getQuery(
	query *gen.ChatGroupQuery,
	req *repo.ChatGroupQuery,
) *gen.ChatGroupQuery {
	if req == nil {
		return query
