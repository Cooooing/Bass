...
func newApp(logger log.Logger, gs *grpc.Server, consumer *consumerPkg.Consumer, deliveryWorker *usecase.DeliveryWorker, cc *commonClient.ConsulClient) *kratos.App {
