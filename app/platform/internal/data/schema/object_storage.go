...
func (ObjectStorage) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("status").Values(enum.ObjectStorageStatusMap.EnumValues()...).Default(enum.ObjectStorageStatusAvailable.String()).Comment("资源状态"),
		field.Int64("upload_by").Comment("上传者 ID"),
