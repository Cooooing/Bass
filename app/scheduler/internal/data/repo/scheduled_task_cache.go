...
func (r *ScheduledTaskCacheRepo) GetScheduledTask(ctx context.Context, taskKey string) (*model.ScheduledTask, error) {
...
func (r *ScheduledTaskCacheRepo) DeleteScheduledTask(ctx context.Context, taskKey string) error {
