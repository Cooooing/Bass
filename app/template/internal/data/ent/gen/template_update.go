...
import (
	...
	"errors"
	"fmt"
	"template/internal/data/ent/gen/predicate"
	"template/internal/data/ent/gen/template"
...
func (_u *TemplateUpdateOne) sqlSave(ctx context.Context) (_node *Template, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "Template.id" for update`)}
	}
