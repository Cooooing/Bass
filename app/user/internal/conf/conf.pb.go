...
const file_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x0fconf/conf.proto\x12\x0fkratos.api.conf\x1a\x1egoogle/protobuf/duration.proto\"\xf4\x01\n" +
	"\tBootstrap\x12/\n" +
	...
	"\x03jwt\x18\x05 \x01(\v2\x14.kratos.api.conf.JwtR\x03jwt\"\xae\x03\n" +
	"\x06Server\x12\x10\n" +
	...
	"\x04grpc\x18\x05 \x01(\v2\x1c.kratos.api.conf.Server.GRPCR\x04grpc\x12\x16\n" +
	"\x06avatar\x18\a \x01(\tR\x06avatar\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\fphone_expire\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\vphoneExpireB\x1eZ\x1cuser/internal/conf/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Registry_Consul)(nil),     // 11: kratos.api.conf.Registry.Consul
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	11, // 10: kratos.api.conf.Registry.consul:type_name -> kratos.api.conf.Registry.Consul
	...
	12, // 13: kratos.api.conf.Jwt.phone_expire:type_name -> google.protobuf.Duration
	12, // 14: kratos.api.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	12, // 15: kratos.api.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	12, // 16: kratos.api.conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	12, // 17: kratos.api.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	12, // 18: kratos.api.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
	12, // 19: kratos.api.conf.Data.Redis.pool_timeout:type_name -> google.protobuf.Duration
	12, // 20: kratos.api.conf.Data.Redis.conn_max_idle_time:type_name -> google.protobuf.Duration
	...
	12, // 24: kratos.api.conf.Registry.Consul.dial_timeout:type_name -> google.protobuf.Duration
