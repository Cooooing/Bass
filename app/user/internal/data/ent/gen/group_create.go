...
func (_c *GroupCreate) SetEndpoint(v string) *GroupCreate {
...
func (_c *GroupCreate) SetModule(v string) *GroupCreate {
	_c.mutation.SetModule(v)
	return _c
}

// SetNillableModule sets the "module" field if the given value is not nil.
func (_c *GroupCreate) SetNillableModule(v *string) *GroupCreate {
	if v != nil {
		_c.SetModule(*v)
	}
	return _c
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.Endpoint(); !ok {
		return &ValidationError{Name: "endpoint", err: errors.New(`gen: missing required field "Group.endpoint"`)}
	}
