...
func authRegisterDraftRedisKey(
	draftType string,
	account string,
) string {
...
func authUserRbacPermissionsPattern(
	userID int64,
) string {
	return fmt.Sprintf("Auth:Rbac:*:{%d}", userID)
}

func authRealmRbacPermissionsPattern(
	realm string,
) string {
	return fmt.Sprintf("Auth:Rbac:%s:*", realm)
}

func (r *AuthCacheRepo) SaveCode(
	ctx context.Context,
...
func (r *AuthCacheRepo) IncrCodeAttempts(
	ctx context.Context,
	codeType string,
	account string,
) (int64, error) {
...
func (r *AuthCacheRepo) DeleteCode(
	ctx context.Context,
	codeType string,
	account string,
) error {
...
func (r *AuthCacheRepo) SaveRegisterDraft(
	ctx context.Context,
	draftType string,
	account string,
	draft *model.RegisterDraft,
	ttl time.Duration,
) error {
...
func (r *AuthCacheRepo) GetRegisterDraft(
	ctx context.Context,
	draftType string,
	account string,
) (*model.RegisterDraft, error) {
...
func (r *AuthCacheRepo) DeleteRegisterDraft(
	ctx context.Context,
	draftType string,
	account string,
) error {
...
func (r *AuthCacheRepo) SaveSession(
	ctx context.Context,
	...
	pipe.HSet(ctx, key, values)
	pipe.Expire(ctx, key, ttl)
	pipe.ZAdd(ctx, authUserSessionsRedisKey(session.UserID), redis.Z{
...
func (r *AuthCacheRepo) GetSession(
	ctx context.Context,
	sessionID string,
...
func (r *AuthCacheRepo) TouchSession(
	ctx context.Context,
	session *model.RefreshSession,
	ttl time.Duration,
) error {
...
func (r *AuthCacheRepo) RotateSessionJTI(
	ctx context.Context,
	sessionID string,
	oldJTI string,
	newJTI string,
...
func (r *AuthCacheRepo) DeleteSession(
	ctx context.Context,
	userID int64,
	sessionID string,
) error {
...
func (r *AuthCacheRepo) DeleteUserSessions(
	ctx context.Context,
	userID int64,
) error {
...
func (r *AuthCacheRepo) SaveRbacPermissions(
	ctx context.Context,
	realm string,
	userID int64,
	permissions []string,
...
func (r *AuthCacheRepo) GetRbacPermissions(
	ctx context.Context,
	realm string,
	userID int64,
) ([]string, bool, error) {
...
func (r *AuthCacheRepo) DeleteRbacPermissions(
	ctx context.Context,
	realm string,
	userID int64,
) error {
...
func (r *AuthCacheRepo) DeleteUserRbacPermissions(
	ctx context.Context,
	userID int64,
) error {
...
func (r *AuthCacheRepo) DeleteRealmRbacPermissions(
	ctx context.Context,
	realm string,
) error {
...
func (r *AuthCacheRepo) deleteByPattern(
	ctx context.Context,
	pattern string,
) error {
	var cursor uint64
