...
func (s *RbacService) UpsertRole(ctx context.Context, req *v1.UpsertRbacRole_Req) (*v1.UpsertRbacRole_Resp, error) {
	...
	if row != nil {
		role = &v1.UpsertRbacRole_Resp_Role{
			Id:          row.ID,
			Realm:       commonenum.LoginRealmMap.MustToProto(row.Realm),
			Code:        row.Code,
			Name:        row.Name,
...
func (s *RbacService) UpsertPermission(ctx context.Context, req *v1.UpsertRbacPermission_Req) (*v1.UpsertRbacPermission_Resp, error) {
	...
	if row != nil {
		permission = &v1.UpsertRbacPermission_Resp_Permission{
			Id:          row.ID,
			Realm:       commonenum.LoginRealmMap.MustToProto(row.Realm),
			Code:        row.Code,
			Name:        row.Name,
	...
	return &v1.UpsertRbacPermission_Resp{
		Row: permission,
	}, nil
}
