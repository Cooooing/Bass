...
func (s *RelationService) Follow(
	ctx context.Context,
	req *v1.FollowRelation_Req,
) (*v1.FollowRelation_Resp, error) {
	err := s.relationUsecase.Follow(ctx, &usecase.FollowRelationReq{
...
func (s *RelationService) Unfollow(
	ctx context.Context,
	req *v1.UnfollowRelation_Req,
) (*v1.UnfollowRelation_Resp, error) {
	err := s.relationUsecase.Unfollow(ctx, &usecase.UnfollowRelationReq{
		ActorID:  req.GetActorId(),
		TargetID: req.GetTargetId(),
	})
...
func (s *RelationService) Block(
	ctx context.Context,
	req *v1.BlockRelation_Req,
) (*v1.BlockRelation_Resp, error) {
	err := s.relationUsecase.Block(ctx, &usecase.BlockRelationReq{
		ActorID:  req.GetActorId(),
		TargetID: req.GetTargetId(),
	})
...
func (s *RelationService) Unblock(
	ctx context.Context,
	req *v1.UnblockRelation_Req,
) (*v1.UnblockRelation_Resp, error) {
	err := s.relationUsecase.Unblock(ctx, &usecase.UnblockRelationReq{
		ActorID:  req.GetActorId(),
		TargetID: req.GetTargetId(),
	})
...
func (s *RelationService) ListFollowing(
	ctx context.Context,
	req *v1.ListFollowingRelations_Req,
) (*v1.ListFollowingRelations_Resp, error) {
	...
	for _, row := range res.Rows {
		reply := &v1.ListFollowingRelations_Resp_Relation{
			Id:       row.ID,
...
func (s *RelationService) ListFollowers(
	ctx context.Context,
	req *v1.ListFollowersRelations_Req,
) (*v1.ListFollowersRelations_Resp, error) {
	...
	for _, row := range res.Rows {
		reply := &v1.ListFollowersRelations_Resp_Relation{
			Id:       row.ID,
			Type:     enum.RelationTypeMap.MustToProto(row.Type),
			ActorId:  row.ActorID,
			TargetId: row.TargetID,
...
func (s *RelationService) ListBlocked(
	ctx context.Context,
	req *v1.ListBlockedRelations_Req,
) (*v1.ListBlockedRelations_Resp, error) {
	...
	for _, row := range res.Rows {
		reply := &v1.ListBlockedRelations_Resp_Relation{
			Id:       row.ID,
			Type:     enum.RelationTypeMap.MustToProto(row.Type),
			ActorId:  row.ActorID,
			TargetId: row.TargetID,
...
func (s *RelationService) MapStatus(
	ctx context.Context,
	req *v1.MapRelationStatuses_Req,
) (*v1.MapRelationStatuses_Resp, error) {
	req = util.OrDefault(req, &v1.MapRelationStatuses_Req{})
	res, err := s.relationUsecase.MapStatus(ctx, &usecase.MapRelationStatusReq{
		ActorID:   req.GetActorId(),
	...
	return &v1.MapRelationStatuses_Resp{
		Statuses: statuses,
	}, nil
}
