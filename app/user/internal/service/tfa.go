...
func NewTfaService(tfaUsecase *usecase.TfaUsecase) *TfaService {
	return &TfaService{
...
func (s *TfaService) Validate(ctx context.Context, req *v1.ValidateTfa_Request) (*v1.ValidateTfa_Reply, error) {
	verified, err := s.tfaUsecase.ValidateByUserID(ctx, req.GetUserId(), req.GetCode())
	if err != nil {
		return nil, err
	}
...
func (s *TfaService) BeginEnable(ctx context.Context, req *v1.BeginEnableTfa_Request) (*v1.BeginEnableTfa_Reply, error) {
	buf, err := s.tfaUsecase.BeginEnable(ctx, req.GetUserId(), req.GetAccountName())
	if err != nil {
		return nil, err
	}
...
func (s *TfaService) ConfirmEnable(ctx context.Context, req *v1.ConfirmEnableTfa_Request) (*v1.ConfirmEnableTfa_Reply, error) {
	err := s.tfaUsecase.Confirm(ctx, req.GetUserId(), req.GetCode())
...
func (s *TfaService) Disable(ctx context.Context, req *v1.DisableTfa_Request) (*v1.DisableTfa_Reply, error) {
	err := s.tfaUsecase.DisableByUserID(ctx, req.GetUserId(), req.GetCode())
	return &v1.DisableTfa_Reply{}, err
}

func (s *TfaService) Get(ctx context.Context, req *v1.GetTfa_Request) (*v1.GetTfa_Reply, error) {
	tfa, err := s.tfaUsecase.GetByUserID(ctx, req.GetUserId())
	if err != nil {
		return nil, err
	}
	reply := &v1.Tfa{UserId: req.GetUserId()}
	if tfa != nil {
	...
	return &v1.GetTfa_Reply{Tfa: reply}, nil
}
