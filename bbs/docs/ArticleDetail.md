...
**reward_content** | **string** |  | [optional] [default to undefined]
**reward_content_render** | **string** |  | [optional] [default to undefined]
**reward_points** | **number** |  | [optional] [default to undefined]
...
**postscripts** | [**Array&lt;ArticlePostscript&gt;**](ArticlePostscript.md) |  | [optional] [default to undefined]
...
```typescript
import { ArticleDetail } from '@bass/bbs-sdk-axios';

const instance: ArticleDetail = {
    id,
    title,
    content,
    content_render,
