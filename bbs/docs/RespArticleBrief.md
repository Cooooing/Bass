...
**author_user** | [**RespAccountProfile**](RespAccountProfile.md) |  | [optional] [default to undefined]
...
```typescript
import { RespArticleBrief } from '@bass/bbs-sdk-axios';

const instance: RespArticleBrief = {
    id,
    title,
    type,
    author_user,
