...
// checks if the GetArticleResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetArticleResp{}

// GetArticleResp struct for GetArticleResp
...
func (o GetArticleResp) MarshalJSON() ([]byte, error) {
...
func (o GetArticleResp) ToMap() (map[string]interface{}, error) {
...
type NullableGetArticleResp struct {
	value *GetArticleResp
	isSet bool
}

func (v NullableGetArticleResp) Get() *GetArticleResp {
	return v.value
}

func (v *NullableGetArticleResp) Set(val *GetArticleResp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetArticleResp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetArticleResp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetArticleResp(val *GetArticleResp) *NullableGetArticleResp {
	return &NullableGetArticleResp{value: val, isSet: true}
}

func (v NullableGetArticleResp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetArticleResp) UnmarshalJSON(src []byte) error {
	v.isSet = true
