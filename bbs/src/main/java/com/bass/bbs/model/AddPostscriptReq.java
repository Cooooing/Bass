 ...
 */
@JsonPropertyOrder({
  AddPostscriptReq.JSON_PROPERTY_ARTICLE_ID,
  AddPostscriptReq.JSON_PROPERTY_CONTENT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class AddPostscriptReq {
  ...
  public AddPostscriptReq() { 
  }

  public AddPostscriptReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public AddPostscriptReq content(@javax.annotation.Nonnull String content) {
  ...
  /**
   * Return true if this AddPostscript_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AddPostscriptReq addPostscriptReq = (AddPostscriptReq) o;
    return Objects.equals(this.articleId, addPostscriptReq.articleId) &&
        Objects.equals(this.content, addPostscriptReq.content);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddPostscriptReq {\n");
