 ...
 */
@JsonPropertyOrder({
  ArchiveArticleReq.JSON_PROPERTY_ARTICLE_ID,
  ArchiveArticleReq.JSON_PROPERTY_REASON
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ArchiveArticleReq {
  ...
  public ArchiveArticleReq() { 
  }

  public ArchiveArticleReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public ArchiveArticleReq reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  /**
   * Return true if this ArchiveArticle_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ArchiveArticleReq archiveArticleReq = (ArchiveArticleReq) o;
    return Objects.equals(this.articleId, archiveArticleReq.articleId) &&
        Objects.equals(this.reason, archiveArticleReq.reason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(articleId, reason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ArchiveArticleReq {\n");
