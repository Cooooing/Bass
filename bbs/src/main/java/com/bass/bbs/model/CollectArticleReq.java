 ...
 */
@JsonPropertyOrder({
  CollectArticleReq.JSON_PROPERTY_ARTICLE_ID,
  CollectArticleReq.JSON_PROPERTY_ACTIVE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class CollectArticleReq {
  ...
  public CollectArticleReq() { 
  }

  public CollectArticleReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public CollectArticleReq active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
  ...
  /**
   * Return true if this CollectArticle_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CollectArticleReq collectArticleReq = (CollectArticleReq) o;
    return Objects.equals(this.articleId, collectArticleReq.articleId) &&
        Objects.equals(this.active, collectArticleReq.active);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectArticleReq {\n");
