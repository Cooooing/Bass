...
public class CollectArticleRequest {
  ...
  public CollectArticleRequest articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public CollectArticleRequest active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
