 ...
 */
@JsonPropertyOrder({
  CreateArticleRequest.JSON_PROPERTY_ARTICLE
})
...
public class CreateArticleRequest {
  ...
  public CreateArticleRequest article(@javax.annotation.Nullable ArticleSave article) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ARTICLE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setArticle(@javax.annotation.Nullable ArticleSave article) {
    this.article = article;
  }


  /**
   * Return true if this CreateArticle_Request object is equal to o.
   */
  @Override
