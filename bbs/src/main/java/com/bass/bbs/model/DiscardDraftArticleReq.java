 ...
 */
@JsonPropertyOrder({
  DiscardDraftArticleReq.JSON_PROPERTY_ARTICLE_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class DiscardDraftArticleReq {
  public static final String JSON_PROPERTY_ARTICLE_ID = "article_id";
  @javax.annotation.Nonnull
  private String articleId;

  public DiscardDraftArticleReq() { 
  }

  public DiscardDraftArticleReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  /**
   * Return true if this DiscardDraftArticle_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DiscardDraftArticleReq discardDraftArticleReq = (DiscardDraftArticleReq) o;
    return Objects.equals(this.articleId, discardDraftArticleReq.articleId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscardDraftArticleReq {\n");
