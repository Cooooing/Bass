...
@JsonPropertyOrder({
  ...
  Domain.JSON_PROPERTY_STATUS,
  Domain.JSON_PROPERTY_URL,
  Domain.JSON_PROPERTY_ICON,
  Domain.JSON_PROPERTY_IS_NAV,
  Domain.JSON_PROPERTY_CREATED_BY,
  Domain.JSON_PROPERTY_UPDATED_BY,
  Domain.JSON_PROPERTY_CREATED_AT,
...
public class Domain {
  ...
  public Domain id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Domain description(@javax.annotation.Nullable String description) {
  ...
  public Domain status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public Domain url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public Domain icon(@javax.annotation.Nullable String icon) {
    this.icon = icon;
    return this;
  }
  ...
  public Domain isNav(@javax.annotation.Nullable Boolean isNav) {
    this.isNav = isNav;
    return this;
  }
  ...
  public Domain createdBy(@javax.annotation.Nullable String createdBy) {
  ...
  public Domain updatedBy(@javax.annotation.Nullable String updatedBy) {
  ...
  public Domain createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public Domain updatedAt(@javax.annotation.Nullable String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domain.id) &&
        ...
        Objects.equals(this.url, domain.url) &&
        Objects.equals(this.icon, domain.icon) &&
        Objects.equals(this.isNav, domain.isNav) &&
        Objects.equals(this.createdBy, domain.createdBy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, status, url, icon, isNav, createdBy, updatedBy, createdAt, updatedAt);
  }
