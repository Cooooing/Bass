 ...
 */
@JsonPropertyOrder({
  ImageResp.JSON_PROPERTY_DATA,
  ImageResp.JSON_PROPERTY_CONTENT_TYPE
})
...
public class ImageResp {
  ...
  public ImageResp data(@javax.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  public ImageResp contentType(@javax.annotation.Nullable String contentType) {
  ...
  /**
   * Return true if this ImageResp object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ImageResp imageResp = (ImageResp) o;
    return Objects.equals(this.data, imageResp.data) &&
        Objects.equals(this.contentType, imageResp.contentType);
  }
