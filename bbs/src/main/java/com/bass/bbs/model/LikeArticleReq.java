 ...
 */
@JsonPropertyOrder({
  LikeArticleReq.JSON_PROPERTY_ARTICLE_ID,
  LikeArticleReq.JSON_PROPERTY_ACTIVE
})
...
public class LikeArticleReq {
  ...
  public LikeArticleReq() { 
  }

  public LikeArticleReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public LikeArticleReq active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
  ...
  /**
   * Return true if this LikeArticle_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LikeArticleReq likeArticleReq = (LikeArticleReq) o;
    return Objects.equals(this.articleId, likeArticleReq.articleId) &&
        Objects.equals(this.active, likeArticleReq.active);
  }
  ...
  public String toString() {
    ...
    sb.append("class LikeArticleReq {\n");
