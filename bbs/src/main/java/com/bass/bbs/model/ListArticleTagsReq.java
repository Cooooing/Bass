 ...
 */
@JsonPropertyOrder({
  ListArticleTagsReq.JSON_PROPERTY_ARTICLE_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListArticleTagsReq {
  public static final String JSON_PROPERTY_ARTICLE_ID = "article_id";
  @javax.annotation.Nonnull
  private String articleId;

  public ListArticleTagsReq() { 
  }

  public ListArticleTagsReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  /**
   * Return true if this ListArticleTags_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListArticleTagsReq listArticleTagsReq = (ListArticleTagsReq) o;
    return Objects.equals(this.articleId, listArticleTagsReq.articleId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListArticleTagsReq {\n");
