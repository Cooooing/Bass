 ...
 */
@JsonPropertyOrder({
  ListArticlesReply.JSON_PROPERTY_PAGE,
  ListArticlesReply.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListArticlesReply {
  ...
  public ListArticlesReply page(@javax.annotation.Nullable PageReply page) {
    this.page = page;
    return this;
  }
  ...
  /**
   * Return true if this ListArticles_Reply object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListArticlesReply listArticlesReply = (ListArticlesReply) o;
    return Objects.equals(this.page, listArticlesReply.page) &&
        Objects.equals(this.rows, listArticlesReply.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListArticlesReply {\n");
