 ...
 */
@JsonPropertyOrder({
  ListArticlesResp.JSON_PROPERTY_PAGE,
  ListArticlesResp.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListArticlesResp {
  ...
  public ListArticlesResp() { 
  }

  public ListArticlesResp page(@javax.annotation.Nullable PageResp page) {
    this.page = page;
    return this;
  }
  ...
  public ListArticlesResp rows(@javax.annotation.Nullable List<ArticleListItem> rows) {
    this.rows = rows;
    return this;
  }

  public ListArticlesResp addRowsItem(ArticleListItem rowsItem) {
    if (this.rows == null) {
  ...
  /**
   * Return true if this ListArticles_Resp object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListArticlesResp listArticlesResp = (ListArticlesResp) o;
    return Objects.equals(this.page, listArticlesResp.page) &&
        Objects.equals(this.rows, listArticlesResp.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListArticlesResp {\n");
