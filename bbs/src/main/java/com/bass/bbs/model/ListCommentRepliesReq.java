 ...
 */
@JsonPropertyOrder({
  ListCommentRepliesReq.JSON_PROPERTY_PAGE,
  ListCommentRepliesReq.JSON_PROPERTY_ARTICLE_ID,
  ListCommentRepliesReq.JSON_PROPERTY_PARENT_ID,
  ListCommentRepliesReq.JSON_PROPERTY_ORDER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListCommentRepliesReq {
  ...
  public ListCommentRepliesReq() { 
  }

  public ListCommentRepliesReq page(@javax.annotation.Nullable PageReq page) {
    this.page = page;
    return this;
  }
  ...
  public ListCommentRepliesReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public ListCommentRepliesReq parentId(@javax.annotation.Nonnull String parentId) {
  ...
  public ListCommentRepliesReq order(@javax.annotation.Nullable OrderEnum order) {
    this.order = order;
    return this;
  }
  ...
  /**
   * Return true if this ListCommentReplies_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListCommentRepliesReq listCommentRepliesReq = (ListCommentRepliesReq) o;
    return Objects.equals(this.page, listCommentRepliesReq.page) &&
        Objects.equals(this.articleId, listCommentRepliesReq.articleId) &&
        Objects.equals(this.parentId, listCommentRepliesReq.parentId) &&
        Objects.equals(this.order, listCommentRepliesReq.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCommentRepliesReq {\n");
