 ...
 */
@JsonPropertyOrder({
  ListCommentRepliesRequest.JSON_PROPERTY_PAGE,
  ListCommentRepliesRequest.JSON_PROPERTY_ARTICLE_ID,
  ListCommentRepliesRequest.JSON_PROPERTY_PARENT_ID,
  ListCommentRepliesRequest.JSON_PROPERTY_ORDER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListCommentRepliesRequest {
  ...
  public ListCommentRepliesRequest() { 
  }

  public ListCommentRepliesRequest page(@javax.annotation.Nullable PageRequest page) {
    this.page = page;
    return this;
  }
  ...
  public ListCommentRepliesRequest articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public ListCommentRepliesRequest parentId(@javax.annotation.Nonnull String parentId) {
  ...
  public ListCommentRepliesRequest order(@javax.annotation.Nullable OrderEnum order) {
    this.order = order;
    return this;
  }
  ...
  /**
   * Return true if this ListCommentReplies_Request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListCommentRepliesRequest listCommentRepliesRequest = (ListCommentRepliesRequest) o;
    return Objects.equals(this.page, listCommentRepliesRequest.page) &&
        Objects.equals(this.articleId, listCommentRepliesRequest.articleId) &&
        Objects.equals(this.parentId, listCommentRepliesRequest.parentId) &&
        Objects.equals(this.order, listCommentRepliesRequest.order);
  }

  @Override
  public int hashCode() {
    return Objects.hash(page, articleId, parentId, order);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListCommentRepliesRequest {\n");
