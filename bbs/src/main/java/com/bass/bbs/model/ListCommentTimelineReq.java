 ...
 */
@JsonPropertyOrder({
  ListCommentTimelineReq.JSON_PROPERTY_PAGE,
  ListCommentTimelineReq.JSON_PROPERTY_ARTICLE_ID,
  ListCommentTimelineReq.JSON_PROPERTY_ORDER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListCommentTimelineReq {
  ...
  public ListCommentTimelineReq() { 
  }

  public ListCommentTimelineReq page(@javax.annotation.Nullable PageReq page) {
    this.page = page;
    return this;
  }
  ...
  public ListCommentTimelineReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public ListCommentTimelineReq order(@javax.annotation.Nullable OrderEnum order) {
    this.order = order;
    return this;
  }
  ...
  /**
   * Return true if this ListCommentTimeline_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListCommentTimelineReq listCommentTimelineReq = (ListCommentTimelineReq) o;
    return Objects.equals(this.page, listCommentTimelineReq.page) &&
        Objects.equals(this.articleId, listCommentTimelineReq.articleId) &&
        Objects.equals(this.order, listCommentTimelineReq.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCommentTimelineReq {\n");
