 ...
 */
@JsonPropertyOrder({
  ListCommentsReply.JSON_PROPERTY_PAGE,
  ListCommentsReply.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListCommentsReply {
  ...
  public ListCommentsReply page(@javax.annotation.Nullable PageReply page) {
    this.page = page;
    return this;
  }
  ...
  /**
   * Return true if this ListComments_Reply object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListCommentsReply listCommentsReply = (ListCommentsReply) o;
    return Objects.equals(this.page, listCommentsReply.page) &&
        Objects.equals(this.rows, listCommentsReply.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCommentsReply {\n");
