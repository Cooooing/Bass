...
public class LoginByPasswordRequest {
  ...
  public LoginByPasswordRequest account(@javax.annotation.Nullable String account) {
  ...
  public LoginByPasswordRequest password(@javax.annotation.Nullable String password) {
