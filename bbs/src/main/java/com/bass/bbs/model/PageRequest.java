 ...
 */
@JsonPropertyOrder({
  PageRequest.JSON_PROPERTY_PAGE,
  PageRequest.JSON_PROPERTY_SIZE
})
...
public class PageRequest {
  ...
  public PageRequest page(@javax.annotation.Nullable Integer page) {
    this.page = page;
    return this;
  }
  ...
  public PageRequest size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  /**
   * Return true if this PageRequest object is equal to o.
   */
  @Override
