 ...
 */
@JsonPropertyOrder({
  UpdateDraftArticleReq.JSON_PROPERTY_ARTICLE_ID,
  UpdateDraftArticleReq.JSON_PROPERTY_ARTICLE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class UpdateDraftArticleReq {
  ...
  @javax.annotation.Nonnull
  private ReqArticle article;

  public UpdateDraftArticleReq() { 
  }

  public UpdateDraftArticleReq articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public UpdateDraftArticleReq article(@javax.annotation.Nonnull ReqArticle article) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ARTICLE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setArticle(@javax.annotation.Nonnull ReqArticle article) {
    this.article = article;
  }


  /**
   * Return true if this UpdateDraftArticle_Req object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateDraftArticleReq updateDraftArticleReq = (UpdateDraftArticleReq) o;
    return Objects.equals(this.articleId, updateDraftArticleReq.articleId) &&
        Objects.equals(this.article, updateDraftArticleReq.article);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDraftArticleReq {\n");
