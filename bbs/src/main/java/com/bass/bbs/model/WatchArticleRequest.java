...
public class WatchArticleRequest {
  ...
  public WatchArticleRequest articleId(@javax.annotation.Nonnull String articleId) {
  ...
  public WatchArticleRequest active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
