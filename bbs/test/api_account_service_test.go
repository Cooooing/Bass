...
func Test_bbs_AccountServiceAPIService(t *testing.T) {
	...
	t.Run("Test AccountServiceAPIService AccountServiceBatchGetProfile", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AccountServiceAPI.AccountServiceBatchGetProfile(context.Background()).Execute()
