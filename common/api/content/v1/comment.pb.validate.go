...
func (m *CommentQueryParams) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CommentQueryParams with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CommentQueryParamsMultiError, or nil if none found.
func (m *CommentQueryParams) ValidateAll() error {
	return m.validate(true)
}

func (m *CommentQueryParams) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CommentQueryParamsMultiError(errors)
	}

	return nil
}

// CommentQueryParamsMultiError is an error wrapping multiple validation errors
// returned by CommentQueryParams.ValidateAll() if the designated constraints
// aren't met.
type CommentQueryParamsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CommentQueryParamsMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CommentQueryParamsMultiError) AllErrors() []error { return m }

// CommentQueryParamsValidationError is the validation error returned by
// CommentQueryParams.Validate if the designated constraints aren't met.
type CommentQueryParamsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CommentQueryParamsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CommentQueryParamsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CommentQueryParamsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CommentQueryParamsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CommentQueryParamsValidationError) ErrorName() string {
	return "CommentQueryParamsValidationError"
}

// Error satisfies the builtin error interface
func (e CommentQueryParamsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCommentQueryParams.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CommentQueryParamsValidationError{}
