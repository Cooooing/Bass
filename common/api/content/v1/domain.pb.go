...
type DomainQueryParams struct {
	...
	// 标签数量范围
	TagCount      *v1.Int32Range `protobuf:"bytes,9,opt,name=tagCount,proto3" json:"tagCount,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_content_v1_domain_proto_rawDesc = "" +
	...
	"\btagCount\x18\t \x01(\v2 .common.api.common.v1.Int32RangeR\btagCountB\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\t\n" +
	"\a_statusB\x06\n" +
	"\x04_urlB\a\n" +
