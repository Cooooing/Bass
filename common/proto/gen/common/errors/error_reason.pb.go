...
// 	protoc        (unknown)
// source: common/errors/error_reason.proto
...
func (ErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_common_errors_error_reason_proto_enumTypes[0].Descriptor()
}

func (ErrorReason) Type() protoreflect.EnumType {
	return &file_common_errors_error_reason_proto_enumTypes[0]
}
...
func (ErrorReason) EnumDescriptor() ([]byte, []int) {
	return file_common_errors_error_reason_proto_rawDescGZIP(), []int{0}
}

var File_common_errors_error_reason_proto protoreflect.FileDescriptor

const file_common_errors_error_reason_proto_rawDesc = "" +
	"\n" +
	" common/errors/error_reason.proto\x12\x15common.api.app.common\x1a\x13errors/errors.proto*\x9d\t\n" +
	...
	"\x1dNetworkAuthenticationRequired\x10\xff\x03\x1a\x04\xa8E\xff\x03\x1a\x04\xa0E\xf4\x03B'Z%common/proto/gen/common/errors;errorsb\x06proto3"

var (
	file_common_errors_error_reason_proto_rawDescOnce sync.Once
	file_common_errors_error_reason_proto_rawDescData []byte
)

func file_common_errors_error_reason_proto_rawDescGZIP() []byte {
	file_common_errors_error_reason_proto_rawDescOnce.Do(func() {
		file_common_errors_error_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_errors_error_reason_proto_rawDesc), len(file_common_errors_error_reason_proto_rawDesc)))
	})
	return file_common_errors_error_reason_proto_rawDescData
}

var file_common_errors_error_reason_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_errors_error_reason_proto_goTypes = []any{
	(ErrorReason)(0), // 0: common.api.app.common.ErrorReason
}
var file_common_errors_error_reason_proto_depIdxs = []int32{
...
func init() { file_common_errors_error_reason_proto_init() }
func file_common_errors_error_reason_proto_init() {
	if File_common_errors_error_reason_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_errors_error_reason_proto_rawDesc), len(file_common_errors_error_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_errors_error_reason_proto_goTypes,
		DependencyIndexes: file_common_errors_error_reason_proto_depIdxs,
		EnumInfos:         file_common_errors_error_reason_proto_enumTypes,
	}.Build()
	File_common_errors_error_reason_proto = out.File
	file_common_errors_error_reason_proto_goTypes = nil
	file_common_errors_error_reason_proto_depIdxs = nil
}
