...
**LastOfflineAt** | Pointer to **time.Time** |  | [optional] 
...
GetLastOfflineAt returns the LastOfflineAt field if non-nil, zero value otherwise.

### GetLastOfflineAtOk

`func (o *Character) GetLastOfflineAtOk() (*time.Time, bool)`

GetLastOfflineAtOk returns a tuple with the LastOfflineAt field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetLastOfflineAt sets LastOfflineAt field to given value.
